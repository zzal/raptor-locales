...
extendLocale('th', 'ไทย', {
    ...
    errorUIOverride: "UI \"{{ชื่อ} }\" รับลงทะเบียนแล้ว และจะถูกเขียนทับ",
    ...
    linkTypeInternalInfo: "<h2>ไม่แน่ใจที่จะใส่ลงในกล่องข้างต้น<\/h2><ol>    <li>พบหน้าเชื่อมโยงกับเว็บไซต์นี้<\/li>    <li>คัดลอกอยู่เว็บจากแถบ ยกเว้น \"{{โด} }\" ที่อยู่ในเบราว์เซอร์ของคุณ และวางลงในช่องด้านบน<\/li><\/ol>",
    ...
    revisionsApplyButtonDialogText: "ย้อนกลับยืนยัน",
    ...
    rfmFileSize: "ขนาด",
    rfmFileType: "ชนิด",
    rfmFilteredTotal: "แสดง {{เริ่มต้น} } {{จบ} } {{filteredTotal } } แฟ้ม",
    rfmFirst: "ครั้งแรก",
    ...
    rfmUploadOr: "หรือ",
    rfmView: "ดู",
    saveJsonFail: "ไม่สามารถบันทึกเนื้อหา block(s) {{ล้ม} }",
    saveJsonSaved: "บันทึกเนื้อหา block(s) {{บันทึก} } เรียบร้อยแล้ว",
    saveNotConfigured: "บันทึกไม่ได้รับการกำหนดค่า หรือถูกปิดใช้งาน",
    saveRestFail: "ไม่สามารถบันทึกเนื้อหา block(s) {{ล้ม} }",
    saveRestPartial: "บันทึก {{บันทึก} } จากบล็อกเนื้อหาไม่ {{สำเร็จ} }",
    saveRestSaved: "บันทึกเนื้อหา block(s) {{บันทึก} } เรียบร้อยแล้ว",
    ...
    statisticsButtonCharacters: "อักขระ {{ตัว} }",
    statisticsDialogCharactersOverLimit: "{{ตัว} } อักขระ, {{charactersRemaining } } มากกว่าขีดจำกัดแนะนำ",
    statisticsDialogCharactersRemaining: "อักขระ {{ตัว} }, {{charactersRemaining } } ที่เหลือ",
    statisticsDialogNotTruncated: "เนื้อหาจะไม่ถูกตัด",
    statisticsDialogOKButton: "ตกลง, ได้",
    statisticsDialogSentence: "ประโยค {{ประโยค} }",
    statisticsDialogSentences: "ประโยค {{ประโยค} }",
    statisticsDialogTitle: "เนื้อหาสถิติ",
    statisticsDialogTruncated: "เนื้อหาประกอบด้วยมากกว่าตัว {{ข้อจำกัด} } และอาจถูกตัดทอน",
    statisticsDialogWord: "{{คำ} } คำ",
    statisticsDialogWords: "{{} } หา",
    ...
    tagTreeElementLink: "เลือกองค์ประกอบ {{องค์ประกอบ} }",
    tagTreeElementTitle: "คลิกเพื่อเลือกเนื้อหาขององค์ประกอบ \"{{องค์} }\"",
    tagTreeRoot: "ราก",

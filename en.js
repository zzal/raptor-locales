...
extendLocale('en', 'English', {
    ...
    rieActionCrop: 'Crop',
    rieActionResize: 'Resize',
    rieActionUpload: 'Upload',
    rieActionRevert: 'Revert',
    rieActionSave: 'Save',
    rieActionUndo: 'Undo',
    rieActionRedo: 'Redo',
    rieActionBlur: 'Blur',
    rieActionSharpen: 'Sharpen',
    rieActionDesaturate: 'Desaturate',
    rieActionInvert: 'Invert',
    rieActionRemoveNoise: 'Remove Noise',
    rieActionSepia: 'Sepia',
    rieActionSolarize: 'Solarize',
    rieActionBrightness: 'Brightness/Contrast',
    rieActionColorAdjust: 'Adjsut Color',
    rieActionGlow: 'Glow',
